...
def Load_Data_NEW(data_path, data_path_bef):
    ...
    kk = 0  # 3893
    kk_k = 0
    # triples_test_G1, triples_test_G1_is_a, triples_test_G1_original
    triples_test_G1 = OrderedDict()   # test, 3985 edges; 3774 entity;
    triples_test_G1_is_a = OrderedDict()
    triples_test_G1_original = OrderedDict()
    with open(os.path.join(data_path, 'test_entity_typeG.txt')) as fin:
        for line in fin:
            ...
            if enid not in triples_test_G1.keys():
                ...
                triples_test_G1_is_a[enid] = list()
                triples_test_G1_original[enid] = list()
            if tyid not in triples_test_G1[enid]:
                triples_test_G1[enid].append(tyid)
                triples_test_G1_is_a[enid].append(tyid)
                triples_test_G1_original[enid].append(tyid)
                kk = kk +1
            kk_k = kk_k + 1
    list_list = [jj, jj_j, kk, kk_k]
    ...
    # G1_graph_sub2_2 == G1_graph_sub2_final_is_a == G1_graph_sub2_original
    return node2id_G2_re, relation2id_G2_re, type_node2id_G1_re, G1_graph_sub3, G1_graph_sub2_2, G1_graph_sub2_final_is_a, G1_graph_sub2_original,G1_graph_sub1, G1_graph_sub1_is_a, triples_test_G1, triples_test_G1_is_a, triples_test_G1_original, list_list
